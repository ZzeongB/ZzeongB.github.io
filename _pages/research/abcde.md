...
**Images**  
- Original model results and comparison visuals
- Problem definition with cell relationship illustration
...
**Images**  
- KNN and Feature Map graphs
- Visual representations of the final idea combining positional and feature maps
...
**Images**  
- Diagrams of model architecture and feature query process
- Cross-attention and deformable attention layer visualizations
...
- Comparative visualizations showing the improvements in cell detection accuracy
...
**Images**  
- Before and after adding the Attention Mask
- Final Attention Map showing connections between relevant cells
